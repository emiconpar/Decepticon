...
| `openai_oauth`        | `chatgpt/gpt-5.5`                         | `chatgpt/gpt-5.4`                             | `chatgpt/gpt-5.4`                             |
...
| ChatGPT Pro/Plus/Team | `openai_oauth` | chatgpt/gpt-5.5, chatgpt/gpt-5.4 | LiteLLM native `chatgpt` provider |
